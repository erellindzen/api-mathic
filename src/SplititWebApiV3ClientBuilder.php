...
class SplititWebApiV3ClientBuilder
{
    /**
     * @var array
     */
    ...
    public function oAuth2SandboxCredentials(OAuth2SandboxCredentialsBuilder $oAuth2Sandbox): self
    {
        $this->config = array_merge($this->config, $oAuth2Sandbox->getConfiguration());
        return $this;
    }

    public function oAuth2ProductionCredentials(OAuth2ProductionCredentialsBuilder $oAuth2Production): self
    {
        $this->config = array_merge($this->config, $oAuth2Production->getConfiguration());
        return $this;
    }
    ...
    public function build(): SplititWebApiV3Client
    {
        return new SplititWebApiV3Client($this->config);
    }
}
