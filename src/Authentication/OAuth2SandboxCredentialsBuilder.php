...
/**
 * Utility class for initializing OAuth2Sandbox security credentials.
 */
class OAuth2SandboxCredentialsBuilder
{
    /**
     * @var array
     */
    ...
    /**
     * Initializer for OAuth2SandboxCredentialsBuilder
     *
    ...
    {
        OAuthScopeOAuth2SandboxEnum::checkValue($oAuthScopes);
    ...
    {
        $this->config['OAuth2-sandbox-ClockSkew'] = $oAuthClockSkew;
        return $this;
    }

    /**
     * Setter for the OAuthTokenProvider callable with 2 arguments. Arg1 will be the last OAuthToken
     * instance, while Arg2 will be an instance of OAuth2SandboxManager. The return type of callable should
     * be an instance of OAuthToken model.
     *
     * @param callable(OAuthToken, OAuth2SandboxManager): OAuthToken $oAuthTokenProvider
     *
     * @return $this
     */
    public function oAuthTokenProvider(callable $oAuthTokenProvider): self
    {
        $this->config['OAuth2-sandbox-TokenProvider'] = $oAuthTokenProvider;
        return $this;
    }
    ...
    {
        $this->config['OAuth2-sandbox-OnTokenUpdate'] = $oAuthOnTokenUpdate;
        return $this;
    }
