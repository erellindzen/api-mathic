 ...
 */
class OAuth2ProductionManager extends CoreAuth implements OAuth2ProductionCredentials
{
    /**
    ...
    /**
     * OAuthScopeOAuth2ProductionEnum value for oAuthScopes.
     */
    public function getOAuthScopes(): ?array
    {
        $oAuthScopes = $this->config['oAuthScopes2'];
        if (is_array($oAuthScopes)) {
            return $oAuthScopes;
        }
        return ConfigurationDefaults::O_AUTH_SCOPES_2;
    }
    ...
    {
        return $this->config['OAuth2-production-ClockSkew'] ?? ConfigurationDefaults::O_AUTH_2_PRODUCTION_CLOCK_SKEW;
    }
    ...
    public function fetchToken(?array $additionalParams = null): OAuthToken
    {
        ...
        $oAuthToken = $this->oAuthApi->requestTokenOAuth2Production(
    ...
    private function getTokenFromProvider(): ?OAuthToken
    {
        ...
        $provider = $this->config['OAuth2-production-TokenProvider'];
        ...
        $updateCallback = $this->config['OAuth2-production-OnTokenUpdate'];
