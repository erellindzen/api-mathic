 ...
 */
class OAuth2SandboxManager extends CoreAuth implements OAuth2SandboxCredentials
{
    /**
    ...
    /**
     * OAuthScopeOAuth2SandboxEnum value for oAuthScopes.
     */
    ...
    {
        return $this->config['OAuth2-sandbox-ClockSkew'] ?? ConfigurationDefaults::O_AUTH_2_SANDBOX_CLOCK_SKEW;
    }
    ...
    public function fetchToken(?array $additionalParams = null): OAuthToken
    {
        ...
        $oAuthToken = $this->oAuthApi->requestTokenOAuth2Sandbox(
    ...
    private function getTokenFromProvider(): ?OAuthToken
    {
        ...
        $provider = $this->config['OAuth2-sandbox-TokenProvider'];
        ...
        $updateCallback = $this->config['OAuth2-sandbox-OnTokenUpdate'];
