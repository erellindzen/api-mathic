...
class ConfigurationDefaults
{
    ...
    public const O_AUTH_SCOPES_2 = null;
    ...
    public const O_AUTH_2_SANDBOX_CLOCK_SKEW = 0;

    public const O_AUTH_2_PRODUCTION_CLOCK_SKEW = 0;
    ...
    public const _ALL = [
        ...
        'oAuthScopes2' => self::O_AUTH_SCOPES_2,
        'OAuth2-sandbox-ClockSkew' => self::O_AUTH_2_SANDBOX_CLOCK_SKEW,
        'OAuth2-sandbox-TokenProvider' => null,
        'OAuth2-sandbox-OnTokenUpdate' => null,
        'OAuth2-production-ClockSkew' => self::O_AUTH_2_PRODUCTION_CLOCK_SKEW,
        'OAuth2-production-TokenProvider' => null,
        'OAuth2-production-OnTokenUpdate' => null,
