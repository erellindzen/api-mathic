...
class MockerShopperToken implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the MockerShopperToken object to a human-readable string representation.
     *
     * @return string The string representation of the MockerShopperToken object.
     */
