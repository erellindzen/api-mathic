...
class InstallmentPlanGetResponse implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the InstallmentPlanGetResponse object to a human-readable string representation.
     *
     * @return string The string representation of the InstallmentPlanGetResponse object.
     */
