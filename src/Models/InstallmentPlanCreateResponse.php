...
class InstallmentPlanCreateResponse implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the InstallmentPlanCreateResponse object to a human-readable string representation.
     *
     * @return string The string representation of the InstallmentPlanCreateResponse object.
     */
