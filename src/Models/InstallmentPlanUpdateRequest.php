...
class InstallmentPlanUpdateRequest implements \JsonSerializable
{
    /**
     * @var string|null
     */
     ...
     * @maps NewAmount
     */
    public function setNewAmount(?string $newAmount): void
    {
        $this->newAmount = $newAmount;
    }

    /**
     * Converts the InstallmentPlanUpdateRequest object to a human-readable string representation.
     *
     * @return string The string representation of the InstallmentPlanUpdateRequest object.
     */
