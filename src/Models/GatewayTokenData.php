...
class GatewayTokenData implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the GatewayTokenData object to a human-readable string representation.
     *
     * @return string The string representation of the GatewayTokenData object.
     */
